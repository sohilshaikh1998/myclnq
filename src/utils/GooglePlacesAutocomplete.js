...
export default class GooglePlacesAutocomplete extends Component {
    ...
    _onPress = (rowData) => {
        AppUtils.console("syncxskxs", rowData);
    ...
    _renderRowData = (rowData) => {
        ...
        return (
            <Text allowFontScaling={false}
                  style={[{flex: 1,textAlign: isRTL ? 'left' : 'auto',marginRight: isRTL ? 10 : 0}, this.props.suppressDefaultStyles ? {} : defaultStyles.description, this.props.styles.description, rowData.isPredefinedPlace ? this.props.styles.predefinedPlacesDescription : {}]}
    ...
    _renderRow = (rowData = {}, sectionID, rowID) => {
        if (!rowData.description) {
            ...
            rowData.description = rowData.vicinity;
        } //I added it here
        return (
            <View>
                {(rowData.description) ?
                    <View
                        ...
                        >
                            <View
                                style={[this.props.suppressDefaultStyles ? {} : defaultStyles.row, this.props.styles.row, rowData.isPredefinedPlace ? this.props.styles.row : {}]}>
