export default {
  ...
  waitingRoom: {
    ...
    yes: 'Yes',
    no: 'No',
    disclaimerText: "Disclaimer : Telemedicine is not suitable for emergency conditions like Chest pain, Recurrent Vomiting, Breathing Difficulties, Severe abdominal pains etc and is recommended to see doctor physically in clinic/Hospital",
  ...
  advisoryNote:{
    ...
    wheelchairMessage: 'For Wheelchair transport, please select "Wheelchair Transport" and "Book Later". There will be a lead time of at least 2 days.',
    confirm: 'Confirm',
    cancel: 'Cancel',
  },
  emergencyMessage: {
