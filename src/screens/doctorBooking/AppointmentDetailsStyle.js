...
const AppointmentDetailsStyle = StyleSheet.create({
    container: {
        flex: 1,
    ...
    block3: {width: wp(41.5), justifyContent: "center"},
    ...
    modalListContentView: {
        width: wp(90),
        borderBottomColor: AppColors.greyBorder, borderBottomWidth: 0,
        alignItems: 'center',
    },
    modalListActionView: {
        width: wp(90),
    ...
    modalListContentViewSubTxt: {
        ...
        fontFamily: AppStyles.fontFamilyMedium,
        fontSize: 12,justifyContent:'center',lineHeight:hp(2.5),
        textAlign: isRTL ? 'left' : 'auto',
    }, textViewStyle: {
...
export default AppointmentDetailsStyle;
