...
class PrimarySettingsHeader extends React.Component {
    constructor(props) {
        super(props);
    }
        ...
        return (
            ...
            <ElevatedView style={[styles.headerStyle, {flexDirection: 'row'}]} elevation={5}>
                ...
                <View style={{width: cellWidth, height: (AppUtils.headerHeight), justifyContent: 'center'}}>
                    <Text allowFontScaling={false} style={styles.headerTextIOS}>{this.props.routeName}</Text>
                </View>
                <View style={{
                    width: cellWidth,
                    height: (AppUtils.headerHeight),
        ...
        return (
            ...
            <ElevatedView style={styles.headerStyle} elevation={5}>
                ...
                <View style={{width: wp(50)}}>
                    <Text allowFontScaling={false} style={styles.headerText}>{this.props.routeName}</Text>
                </View>
...
export default PrimarySettingsHeader;